...
class Mem3DTrainer:
    def __init__(self, model: Mem3D, train_loader: DataLoader, val_loader: DataLoader):
        ...
        lr_lambda = lambda epoch: 1.0 if epoch < 150 else 0.5
...
if __name__ == '__main__':
    ...
    # It requires a functional ShapeNetDataset, which we don't have here.
    # We will run this from main.py
    print("Trainer class defined. Run from main.py to start training.")
